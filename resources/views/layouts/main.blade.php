...
<header>
    ...
    <a href="/" class="navbar-brand ">
                <img src="/img/logoext.png" alt="IFSP" style ="text-align:center;">
    </a>
    ...
    <span class="navbar-toggler-icon"></span>
            ...
            <UL class="navbar-nav" id="navbar-nav-left" >
                ...
                <li class="nav-item m-2 e">
                    <a href="/" class="navbar-link">Loja</a>
                </li>

                <li class="nav-item m-2 ">
                    <a href="/events/create" class="navbar-link">Publicar Jogo</a>
                </li>
                @auth
                    <li class="nav-item m-2 ">
                        <a href="/dashboard" class="navbar-link">Meus Jogos Publicados</a>
                    </li>
                    <li class="nav-item m-2 ">
                        <a href="/library" class="navbar-link">Biblioteca</a>
                    </li>
                @endauth
